...
def get_transaction_data():
    ...
    try:
        ...
        print('Retrieving Transaction Data...')
...
def get_quota_data():
    ...
    sql_query = 'SELECT [sales_id],[SalesName],[sales_name],[sales_group],[Fact_Entity],[year_id],[Amount],[Month],[efftive_date],[tran_type],[Sector],[SF_Sector],[Master_Sector] FROM [SALES].[dbo].[local_sales_person_quota]'
    ...
    column_names = ["sales_id","SalesName","sales_name","sales_group","Fact_Entity","year_id","Amount","Month","efftive_date","tran_type","Sector","SF_Sector","Master_Sector"]
